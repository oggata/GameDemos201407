...
var Chip = cc.Node.extend({
    ...
    ctor:function (posX,posY,game,type) {
        ...
        }else if(this.type == "item_001"){
            this.chipSprite = cc.Sprite.create(s_mapchip_00A);
        }else if(this.type == "item_002"){
            this.chipSprite = cc.Sprite.create(s_mapchip_00B);
        }else if(this.type == "item_003"){
            this.chipSprite = cc.Sprite.create(s_mapchip_00C);
        }
    ...
    update:function() {
        ...
        if(this.isOccupied == false && this.hp <= 0){
            ...
            //カットインを表示する
            if(this.type == "item_001" || this.type == "item_002" || this.type == "item_003"){
                this.game.cutIn.set_text(
                    "ID:xxは、とても興奮した."
                );
                //コインを作成する
